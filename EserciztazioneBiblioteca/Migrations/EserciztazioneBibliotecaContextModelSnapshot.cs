...
namespace EserciztazioneBiblioteca.Migrations
{
    ...
    partial class EserciztazioneBibliotecaContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EserciztazioneBiblioteca.Models.LibroPrestito", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EserciztazioneBiblioteca.Models.LibroPrestito", b =>
                {
                    b.HasOne("EserciztazioneBiblioteca.Models.Libro", "Libro")
                        .WithMany("LibriPrestiti")
                        .HasForeignKey("LibroId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EserciztazioneBiblioteca.Models.Prestito", "Prestito")
                        .WithMany("LibriPrestiti")
                        .HasForeignKey("PrestitoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
